...
func (mCF *MockCF) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
   ...
   `)))
	case "/v2/apps/078e6e80-151f-4d2d-b53b-a558caa65fff/env":
		rw.Write([]byte(fmt.Sprintf(`{
         "staging_env_json": {},
         "running_env_json": {},
         "environment_json": {},
         ...
         "application_env_json": {
            "VCAP_APPLICATION": {
               ...
               "application_name": "spring-music-guille",
               "application_uris": [
                  "spring-music-guille-terrific-mongoose-fo.dev.cfdev.sh"
               ],
               "name": "spring-music-guille",
               "space_name": "cfdev-space",
               "space_id": "1bc28d24-6498-4439-b88d-d3d73f5f7ef6",
               "uris": [
                  "spring-music-guille-terrific-mongoose-fo.dev.cfdev.sh"
               ],
               "users": null,
               "application_id": "078e6e80-151f-4d2d-b53b-a558caa65fff",
               "version": "2c700653-2f25-416e-9dfb-61dd5a0f480d",
               "application_version": "2c700653-2f25-416e-9dfb-61dd5a0f480d"
            }
         }
      }`)))
	case "/v2/apps/078e6e80-151f-4d2d-b53b-a558caa65fff/instances":
		rw.Write([]byte(fmt.Sprintf(`{
         "0": {
            "state": "RUNNING",
            "uptime": 30932,
	...
	case "/v2/apps/078e6e80-151f-4d2d-b53b-a558caa65fff":
		rw.Write([]byte(fmt.Sprintf(`{
         "metadata": {
            "guid": "078e6e80-151f-4d2d-b53b-a558caa65fff",
            "url": "/v2/apps/078e6e80-151f-4d2d-b53b-a558caa65fff",
            "created_at": "2020-02-09T15:55:34Z",
            "updated_at": "2020-02-09T15:55:44Z"
         },
         "entity": {
            "name": "spring-music-guille",
            "production": false,
            "space_guid": "1bc28d24-6498-4439-b88d-d3d73f5f7ef6",
            "stack_guid": "b05dde77-bad1-4647-8b5e-e6e5ef934990",
            "buildpack": null,
            "detected_buildpack": "client-certificate-mapper=1.8.0_RELEASE container-security-provider=1.16.0_RELEASE java-buildpack=\u001B[34mv4.16.1\u001B[0m-offline-https://github.com/cloudfoundry/java-buildpack.git#41b8ff8 java-main java-opts java-security jvmkill-agent=1.16.0_RELEASE open-jd...",
            "detected_buildpack_guid": "21dba288-3b94-4229-a14e-951e87e407e6",
            "environment_json": {},
            "memory": 1024,
            "instances": 1,
            "disk_quota": 1024,
            ...
            "console": false,
            "debug": null,
            "staging_task_id": "2775f384-2f97-4b92-866d-f1169487fa89",
            "package_state": "STAGED",
            "health_check_type": "port",
            "health_check_timeout": null,
            "health_check_http_endpoint": null,
            ...
            "package_updated_at": "2020-02-09T15:55:35Z",
            "detected_start_command": "JAVA_OPTS=\"-agentpath:$PWD/.java-buildpack/open_jdk_jre/bin/jvmkill-1.16.0_RELEASE=printHeapHistogram=1 -Djava.io.tmpdir=$TMPDIR -Djava.ext.dirs=$PWD/.java-buildpack/container_security_provider:$PWD/.java-buildpack/open_jdk_jre/lib/ext -Djava.security.properties=$PWD/.java-buildpack/java_security/java.security $JAVA_OPTS\" && CALCULATED_MEMORY=$($PWD/.java-buildpack/open_jdk_jre/bin/java-buildpack-memory-calculator-3.13.0_RELEASE -totMemory=$MEMORY_LIMIT -loadedClasses=22014 -poolType=metaspace -stackThreads=250 -vmOptions=\"$JAVA_OPTS\") && echo JVM Memory Configuration: $CALCULATED_MEMORY && JAVA_OPTS=\"$JAVA_OPTS $CALCULATED_MEMORY\" && MALLOC_ARENA_MAX=2 SERVER_PORT=$PORT eval exec $PWD/.java-buildpack/open_jdk_jre/bin/java $JAVA_OPTS -cp $PWD/. org.springframework.boot.loader.JarLauncher",
            "enable_ssh": true,
            "ports": [
               8080
            ],
            "space_url": "/v2/spaces/1bc28d24-6498-4439-b88d-d3d73f5f7ef6",
            "stack_url": "/v2/stacks/b05dde77-bad1-4647-8b5e-e6e5ef934990",
            "routes_url": "/v2/apps/078e6e80-151f-4d2d-b53b-a558caa65fff/routes",
            "events_url": "/v2/apps/078e6e80-151f-4d2d-b53b-a558caa65fff/events",
            "service_bindings_url": "/v2/apps/078e6e80-151f-4d2d-b53b-a558caa65fff/service_bindings",
            "route_mappings_url": "/v2/apps/078e6e80-151f-4d2d-b53b-a558caa65fff/route_mappings"
         }
      }`)))
	case "/v2/apps/51e6a412-4fd7-4fa2-9a1a-ca8e2c9a882a/env":
		rw.Write([]byte(fmt.Sprintf(`{
         "staging_env_json": {},
         "running_env_json": {},
         "environment_json": {
         ...
         "application_env_json": {
            "VCAP_APPLICATION": {
               ...
               "application_name": "apps-manager-js-green",
               "application_uris": [
                  "apps.dev.cfdev.sh"
               ],
               "name": "apps-manager-js-green",
               "space_name": "system",
               "space_id": "5c07d1ce-2e96-4946-8aea-ba73f378654c",
               "uris": [
                  "apps.dev.cfdev.sh"
               ],
               "users": null,
               "application_id": "51e6a412-4fd7-4fa2-9a1a-ca8e2c9a882a",
               "version": "59603ad9-db34-49c5-b271-791809838edf",
               "application_version": "59603ad9-db34-49c5-b271-791809838edf"
            }
         }
      }`)))
	case "/v2/apps/51e6a412-4fd7-4fa2-9a1a-ca8e2c9a882a/instances":
		rw.Write([]byte(fmt.Sprintf(`{
         "0": {
            "state": "RUNNING",
            "uptime": 49680,
	...
	case "/v2/apps/51e6a412-4fd7-4fa2-9a1a-ca8e2c9a882a":
		rw.Write([]byte(fmt.Sprintf(`{
      "metadata": {
         "guid": "51e6a412-4fd7-4fa2-9a1a-ca8e2c9a882a",
         "url": "/v2/apps/51e6a412-4fd7-4fa2-9a1a-ca8e2c9a882a",
         "created_at": "2020-02-09T10:41:41Z",
         "updated_at": "2020-02-09T10:42:48Z"
      },
      "entity": {
         "name": "apps-manager-js-green",
         "production": false,
         "space_guid": "5c07d1ce-2e96-4946-8aea-ba73f378654c",
         "stack_guid": "b05dde77-bad1-4647-8b5e-e6e5ef934990",
         "buildpack": "staticfile_buildpack",
         "detected_buildpack": "staticfile",
         "detected_buildpack_guid": "8f5e9ff4-ba3f-4491-87f5-e3194a65d1dd",
         "environment_json": {
            "ACCENT_COLOR": "#00A79D",
            "ACCOUNT_URL": "https://login.dev.cfdev.sh/profile",
            "AMJS_ENV_VAR_KEYS": "ACCENT_COLOR ACCOUNT_URL APP_POLL_INTERVAL APPS_DOMAIN APPS_MANAGER_UAA_CLIENT_ID APPS_MANAGER_URL BILLING_ENABLED CLOUD_CONTROLLER_URL COMPANY_NAME CREATE_UPS_ENABLED CURRENCY_LOOKUP DISABLE_HTTP_FOR_LINKS DISPLAY_PLAN_PRICES DOCS_BASE_URL ENABLE_INVITING_USERS FEEDBACK_SERVICE_URL FOOTER_LINKS FOOTER_TEXT GLOBAL_WRAPPER_BG_COLOR GLOBAL_WRAPPER_FOOTER_CONTENT GLOBAL_WRAPPER_HEADER_CONTENT GLOBAL_WRAPPER_TEXT_COLOR HEAP_ANALYTICS_PROJECT_ID HIDE_APP_SEARCH HIDE_BETA_FEATURES INVITATIONS_SERVICE_ENABLED INVITATIONS_SERVICE_URL LOGGREGATOR_URL LOGGREGATOR_WEBSOCKET_URL LOGOUT_URL MAJOR_VERSION MARKETPLACE_NAME METRICS_URL MINOR_VERSION POLL_INTERVAL PRODUCT_NAME PUSH_APP_DOCS_URL SERVICE_PARAMS_DOCS_URL SIDEBAR_LINKS SYSTEM_DOMAIN UAA_URL USAGE_SERVICE_URL",
         ...
         "console": false,
         "debug": null,
         "staging_task_id": "036565c1-05a3-4f72-bfd0-a3da145abaec",
         "package_state": "STAGED",
         "health_check_type": "port",
         "health_check_timeout": null,
         "health_check_http_endpoint": null,
         ...
         "package_updated_at": "2020-02-09T10:41:41Z",
         "detected_start_command": "$HOME/boot.sh",
         "enable_ssh": true,
         "ports": [
            8080
         ],
         "space_url": "/v2/spaces/5c07d1ce-2e96-4946-8aea-ba73f378654c",
         "stack_url": "/v2/stacks/b05dde77-bad1-4647-8b5e-e6e5ef934990",
         "routes_url": "/v2/apps/51e6a412-4fd7-4fa2-9a1a-ca8e2c9a882a/routes",
         "events_url": "/v2/apps/51e6a412-4fd7-4fa2-9a1a-ca8e2c9a882a/events",
         "service_bindings_url": "/v2/apps/51e6a412-4fd7-4fa2-9a1a-ca8e2c9a882a/service_bindings",
         "route_mappings_url": "/v2/apps/51e6a412-4fd7-4fa2-9a1a-ca8e2c9a882a/route_mappings"
      }
   }`)))
